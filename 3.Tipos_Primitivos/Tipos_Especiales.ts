...
let vacio: void; //no tiene tipo de retorno, este se utiliza con funciones
...
let nunca: never; //la funcion nunca retorna un valor valido
...
console.log('-----');
 ...
 let variableUndefined:undefined = undefined; // se puede utilizar cono tipo y definir, esto significa la ausencia de un valor
